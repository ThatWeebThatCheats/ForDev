...
namespace Hooks
{
	...
	long __stdcall hookEndScene(IDirect3DDevice9* device);
    ...
    void __stdcall hookPlaySound(const char* name);
    void __stdcall hookDrawModelExecute(IMatRenderContext* ctx, const DrawModelState_t& state, const ModelRenderInfo_t& pInfo, matrix3x4_t* pCustomBoneToWorld);
    ...
    int  __stdcall hookDoPostScreenEffects(int a1);
